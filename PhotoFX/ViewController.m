...
- (IBAction)saveImageToAlbum:(id)sender {
    UIImageWriteToSavedPhotosAlbum(self.selectedImageView, self, @selector(image:didFinishSavingWithError:contextInfo:), nil);
}
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    switch (buttonIndex) {
        ...
        case 1:
            ...
            break;
        case 2:
            selectedFilter = [[GPUImageToneCurveFilter alloc] initWithACV:@"CurveConcept"];
            break;
        case 3:
            selectedFilter = [[GPUImageToneCurveFilter alloc] initWithACV:@"testCurve"];
            break;
        case 4:
